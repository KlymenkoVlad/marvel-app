const Spinner = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{margin: '0 auto', background: 'none', display: 'block'}}xmlnsXlink="http://www.w3.org/1999/xlink" version="1.0" width="82px" height="82px" viewBox="0 0 128 128" xmlSpace="preserve">
